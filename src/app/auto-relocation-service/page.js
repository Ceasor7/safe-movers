    ...
    <div className="mt-5 mx-5 sm:mx-24 items-center">
      ...
      <div className="flex flex-col sm:flex-row sm:gap-x-10">
        <div className="sm:w-2/3 flex flex-col">
          ...
          <div className="my-7">
            <h1 className="text-4xl mb-3 font-bold text-[#570987]">
            ...
            <div className="my-7">
              ...
              <p>
                Safe Movers boasts a team of seasoned professionals with
                extensive expertise in the intricate realm of vehicle
                transportation. Our staff undergoes rigorous training and stays
                updated with the latest industry advancements, ensuring that
                your vehicle is handled with utmost care and proficiency
              ...
              <p>
                ...
                safety protocols and employ cutting-edge equipment to safeguard
                your vehicle during every stage of the transportation journey.
                From secure loading techniques to careful handling and
                transport, we prioritize the protection of your valuable assets.
              </p>
              <h2 className="font-bold my-3 text-lg text-gray-500">
                3. Tailored Solutions
              </h2>
              <p>
                We understand that each vehicle and relocation requirement is
                unique. Our approach is highly personalized, offering tailored
                solutions to meet specific client needs. Whether it’s a luxury
                car, a fleet of vehicles, or a specialized automobile, our
                services are adaptable to accommodate diverse transportation
                demands.
              </p>
              <h2 className="font-bold my-3 text-lg text-gray-500">
                4. Reliable Network and Partnerships
              </h2>
              <p>
              ...
              <p>
                We pride ourselves on adhering strictly to all legal and
                regulatory requirements governing vehicle transportation. Our
                compliance with international standards and industry
                accreditations signifies our commitment to maintaining the
                highest levels of professionalism, ensuring a hassle-free
              ...
              <p>
                Communication is key throughout the relocation process. We
                maintain transparent and open communication channels with our
                clients, providing regular updates on the status of their
                vehicle transport. Our dedicated team is always available to
              ...
              <p>
                At Safe Movers, our clients are at the core of everything we do.
                We prioritize customer satisfaction, striving to exceed
                expectations by delivering exceptional service. Our focus on
                building long-term relationships is reflected in our dedication
                to ensuring a smooth and stress-free experience for every
                client.
              </p>
              <h2 className="font-bold my-3 text-lg text-gray-500">
                8. Track Record of Excellence
              </h2>
              <p>
                Our track record speaks volumes. Over the years, Safe Movers has
                earned a reputation for excellence in the moving services
                industry. Countless successful vehicle relocations, coupled with
                glowing testimonials from satisfied clients, serve as testament
                to our commitment to delivering top-tier services consistently.
              </p>
              <h2 className="font-bold my-3 text-lg text-gray-500">
                9. Comprehensive Services
              </h2>
              <p>
                Apart from offering specialized car moving services, Safe Movers
                provides an array of complementary relocation solutions. From
                household moves to commercial relocations, our comprehensive
                suite of services caters to all your moving needs under one
                roof. <br /> <br />
                Choosing Safe Movers for your car moving needs means entrusting
                your vehicle to a team dedicated to ensuring a seamless and
