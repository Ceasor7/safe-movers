    ...
    <div className="flex flex-col">
      <div className="relative bg-fixed bg-parallax bg-cover py-36">
        ...
        <div className="absolute inset-0 flex flex-col">
          <h1 className="mx-5 sm:mx-24 text-2xl sm:text-5xl font-bold">
            Buy Comprehensive Home Insurance in Kenya
          </h1>
          <p className="mx-5 sm:mx-24 my-7">
            Protect your family and possessions with the most comprehensive home
            insurance cover in Kenya.
          </p>
          <Link
            href="#"
            className="bg-[#570598] text-white w-36 px-7 py-4 mx-5 sm:mx-24 rounded-lg"
          >
            Get started
          </Link>
        </div>
      ...
      <div>
        <div className="flex flex-col sm:flex-row justify-between mx-5 mb-10 mt-10 sm:mx-24">
        ...
        <div className="flex flex-col sm:flex-row justify-between mx-5 my-3 sm:mx-24 gap-x-16 gap-y-8">
      ...
      <div className="flex my-8 flex-col sm:flex-row gap-x-28 gap-y-14 bg-gray-200 py-10">
        <div className="flex justify-center items-center mx-5 sm:mx-24 ">
          <img src="/video-holder-2.webp" alt="Sitiri Home Insurance" />
        </div>
        <div className="flex flex-col justify-center items-center text-center mx-5 sm:mx-24 ">
      ...
      <div className="mx-5 sm:mx-24">
        ...
        <div className="flex flex-col sm:flex-row gap-x-10 gap-y-12">
          <div className="flex flex-col border rounded-2xl border-[#570987] p-2">
      ...
      <div className="flex flex-col">
        <h1 className="mx-5 sm:mx-24 text-2xl font-bold my-3">
          Exceptions of events that would be covered
        </h1>
        <p className="mx-5 sm:mx-24 mb-3">
        ...
        <div className="flex flex-col justify-center mx-5 sm:mx-24 sm:flex-row gap-x-10 gap-y-10">
          <div className="relative flex flex-col px-32 py-32 border rounded-2xl border-[#570987] bg-[#570598]">
          ...
          <div className="relative flex flex-col px-32 py-32 border rounded-2xl border-[#570987]">
      ...
      <div className="flex my-8 flex-col mx-5 sm:mx-24 sm:flex-row gap-x-28 gap-y-14">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8 mt-5 mx-5 sm:mx-24 items-center">
      ...
      <div className="flex flex-col sm:flex-row gap-x-10 mt-5 py-10 items-center bg-gray-200">
        <div className="sm:w-1/3 mb-3 mx-5 sm:mx-24">
          <div>
            <img src="/sitiri-imag2.webp" alt="Sitiri Home Insurance" />
          </div>
        </div>
        <div className="sm:w-2/3 flex flex-col mx-5 sm:mx-24">
          <h1 className="text-2xl font-bold">
          ...
          <div className="flex flex-col my-4 sm:flex-row gap-x-10">
            <Link
              href="/contact"
              className="bg-[#570598] px-6 py-4 w-44 text-center text-white rounded-lg"
            >
              Write to us
            </Link>
